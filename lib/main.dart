...
import 'package:sw_hackathon/route/prevsession.dart';
...
void main() async {
  ...
  runApp(
    ChangeNotifierProvider(create: (_) => ExerciseData(), child: const MyApp()),
  );
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/prevsession': (context) => const Prevsession(),
      },
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color.fromARGB(255, 161, 198, 92),
        ),
      ),
    );
  }
